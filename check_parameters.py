...
if __name__ == "__main__":
    ...
    vo = system   # however you create the object
    
    modules = {
        "Frontend": vo.Frontend,
        "MotionEstimator": vo.MotionEstimator,
        "KeypointSelector": vo.KeypointSelector,
        "MappointSelector": vo.MappointSelector,
        "OutlierFilter": vo.OutlierFilter,
        "ObsCovModel": vo.ObsCovModel,
        "MapRefiner": vo.MapRefiner,
        "KeyframeSelector": vo.KeyframeSelector,
        "Optimizer": vo.Optimizer,
    }
